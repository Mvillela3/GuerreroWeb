...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <AlternatingRowStyle BackColor="#CCCCCC" />
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Id" Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="LblId" Text='<%# Bind("IdEst") %>'></asp:Label>
                        </ItemTemplate>
    ...
    <asp:Panel ID="VtMdl" runat="server" CssClass="campo_cen_cen" style="width:550px; height:400px" ViewStateMode="Enabled" Visible="False" >
        ...
        <table width="100%">
            <tr>
                <td colspan="4">
                    <asp:Label ID="Label1" runat="server" Text="Detalle del Estado" Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="4"><br /></td>
