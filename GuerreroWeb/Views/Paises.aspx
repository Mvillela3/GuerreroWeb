<%@ Page Title="Catálogo de Paises" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Views/Paises.aspx.cs" Inherits="GuerreroWeb.Views.Paises" %>
...
<div style="width:100%;height:75vh;" class="mh-100">
            ...
            <AlternatingRowStyle BackColor="#CCCCCC" />
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Id" Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="LblId" Text='<%# Bind("IdPais") %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Abreviatura">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="LblAbrevia" Text='<%# Bind("Abreviatura") %>'></asp:Label>
                        </ItemTemplate>
                    <FooterStyle Width="5%" />
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="20%" Height="40px" />
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="20%" Height="30px" />
    ...
    <asp:Panel ID="VtMdl" runat="server" CssClass="campo_cen_cen" style="width:550px; height:400px" ViewStateMode="Enabled" Visible="False" >
        ...
        <table width="100%">
            <tr>
                <td colspan="4">
                    <asp:Label ID="Label1" runat="server" Text="Detalle del País" Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="4"><br /></td>
