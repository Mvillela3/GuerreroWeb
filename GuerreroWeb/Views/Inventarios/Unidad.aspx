<%@ Page Title="Catálogo de Unidades" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Views/Inventarios/Unidad.aspx.cs" Inherits="GuerreroWeb.Views.Inventarios.Unidad" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	function avisos1(objeto) {
			...
			//alert(objeto);
			if (objeto == "MainContent_TxtUnidad") {
			...
			if (objeto == "MainContent_TxtDescripcion") {
				largo = document.getElementById(objeto).value;

				document.getElementById("MainContent_LblMensaje2").innerHTML = "Este Campo es Obligatorio";
				if (largo.length == 0) {
					document.getElementById("MainContent_LblMensaje2").style.display = "";
					//alert("si");
				}
				else {
					document.getElementById("MainContent_LblMensaje2").style.display = "none";
					//alert("no");
				}
			}
			if (objeto == "MainContent_TxtClave") {
				largo = document.getElementById(objeto).value;

				document.getElementById("MainContent_LblMensaje3").innerHTML = "Este Campo es Obligatorio";
				if (largo.length == 0) {
					document.getElementById("MainContent_LblMensaje3").style.display = "";
					//alert("si");
				}
				else {
					document.getElementById("MainContent_LblMensaje3").style.display = "none";
					//alert("no");
				}
			}
		...
		<table width="100%">
			<tr>
				<td colspan="4" style="background-color: black; padding: 10px 10px 10px 10px;">
					<asp:Label ID="LblTitulo" runat="server" Text="Catálogo de Unidades de Medida" ForeColor="White" Font-Bold="True"></asp:Label>
				</td>
			</tr>
				...
				<asp:GridView ID="GvConsulta" runat="server" Width="100%" Height="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AllowPaging="True" ShowHeaderWhenEmpty="True" ViewStateMode="Enabled" OnRowDataBound="GvConsulta_RowDataBound" OnRowDeleting="GvConsulta_RowDeleting" OnRowEditing="GvConsulta_RowEditing" OnPageIndexChanging="GvConsulta_PageIndexChanging">
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="Unidad" Visible="true">
							<ItemTemplate>
								<asp:Label runat="server" ID="LblId" Text='<%# Bind("Unidad") %>'></asp:Label>
							</ItemTemplate>
						...
						<asp:TemplateField HeaderText="Descripcion">
							<ItemTemplate>
								<asp:Label runat="server" ID="LblDesc" Text='<%# Bind("Descripcion") %>'></asp:Label>
							</ItemTemplate>
							<FooterStyle Width="5%" />
						...
						<asp:TemplateField HeaderText="Clave SAT">
							<ItemTemplate>
								<asp:Label runat="server" ID="LblClave" Text='<%# Bind("ClaveSat") %>'></asp:Label>
							</ItemTemplate>
							<FooterStyle Width="5%" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="20%" Height="40px" />
							<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="20%" Height="30px" />
	...
	<asp:Panel ID="VtMdl" runat="server" CssClass="campo_cen_cen" Style="width: 700px; height: 500px" ViewStateMode="Enabled" Visible="False">
		<div class="campo_cen_cen alin-col FondoMsg VtnMsg" style="width: 700px; height: 500px">
			<table width="100%">
				<tr>
					<td colspan="4">
						<asp:Label ID="Label1" runat="server" Text="Detalle de la Unidad de Medida" Font-Bold="True" Font-Size="Larger"></asp:Label>
					</td>
				</tr>
				<tr>
					<td colspan="4">
				...
				<tr>
					<td class="campo_cen_izq" colspan="2" style="padding: 2px 10px  2px  10px;">
						<asp:Label ID="Label2" runat="server" Text="Unidad:" BorderStyle="None" Font-Size="Medium" Style="text-align: justify; padding: 0  10px  0  10px" ViewStateMode="Enabled" Font-Bold="True"></asp:Label>
					...
					<td class="campo_cen_izq" colspan="2" style="padding: 2px 10px  2px  10px;">
						<asp:TextBox ID="TxtUnidad" runat="server" Width="100%" MaxLength="60" ViewStateMode="Enabled" onblur="avisos1(this.id);" CssClass="coldiv1" onfocus="this.select()" OnTextChanged="TxtUnidad_TextChanged"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td class="campo_cen_izq" colspan="2" style="padding: 2px 10px  2px  10px;">
						<asp:Label ID="Label3" runat="server" Text="Descripcion:" BorderStyle="None" Font-Size="Medium" Style="text-align: justify; padding: 0  10px  0  10px" ViewStateMode="Enabled" Font-Bold="True"></asp:Label>
						<asp:Label ID="LblMensaje2" runat="server" Text="" onclick="avisos1(this.id);" ForeColor="#FF3300" Font-Size="Small" Font-Bold="True" Style="display: none;"></asp:Label>
					</td>
					<td class="campo_cen_izq" colspan="2" style="padding: 2px 10px  2px  10px;">
						<asp:TextBox ID="TxtDescripcion" runat="server" Width="100%" MaxLength="60" ViewStateMode="Enabled" onblur="avisos1(this.id);" CssClass="coldiv1" onfocus="this.select()" OnTextChanged="TxtDescripcion_TextChanged"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td class="campo_cen_izq" colspan="2" style="padding: 2px 10px  2px  10px;">
						<asp:Label ID="Label4" runat="server" Text="Clave SAT:" BorderStyle="None" Font-Size="Medium" Style="text-align: justify; padding: 0  10px  0  10px" ViewStateMode="Enabled" Font-Bold="True"></asp:Label>
						<asp:Label ID="LblMensaje3" runat="server" Text="" onclick="avisos1(this.id);" ForeColor="#FF3300" Font-Size="Small" Font-Bold="True" Style="display: none;"></asp:Label>
					</td>
					<td class="campo_cen_izq" colspan="2" style="padding: 2px 10px  2px  10px;">
						<asp:TextBox ID="TxtClave" runat="server" Width="100%" MaxLength="60" ViewStateMode="Enabled" onblur="avisos1(this.id);" CssClass="coldiv1" onfocus="this.select()" OnTextChanged="TxtClave_TextChanged"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td colspan="4">
