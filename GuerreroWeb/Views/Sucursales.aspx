<%@ Page Title="Catálogo de Sucursales" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Views/Sucursales.aspx.cs" Inherits="GuerreroWeb.Views.Sucursales" %>
                ...
                <AlternatingRowStyle BackColor="#CCCCCC" />
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Id" Visible="False">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="LblId" Text='<%# Bind("IdSuc") %>'></asp:Label>
                            </ItemTemplate>
                       ...
                       <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" />
                        ...
                        <asp:TemplateField HeaderText="Telefono 1">
                             <itemTemplate>
                                <asp:Label runat="server" ID="LblTel1" Text='<%# Bind("Telefono1") %>'></asp:Label>
                            </itemTemplate>
                       <FooterStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="10%" />
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" Height="40px" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" Height="30px" />
                        ...
                        <asp:TemplateField HeaderText="Telefono 2">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="LblRFC" Text='<%# Bind("Telefono2") %>'></asp:Label>
                            </ItemTemplate>
